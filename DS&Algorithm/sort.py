...
# Quick Sort (이 때, pivot의 값은 항상 입력받은 배열의 left값에 의거해 정해진다.)
...
# Try another version!! Quick Sort -> 한개의 함수로 합친 것 (순수 재귀함수)
...
if __name__ == '__main__':
    n_sort_arr = [5, 4, 3, 1, 2]
    #selection_sort(n_sort_arr)
    #insertion_sort(n_sort_arr)
    #bubble_sort(n_sort_arr)
    #print(merge_sort(n_sort_arr))
    #quick_sort2(n_sort_arr, 0, len(n_sort_arr)-1))
    #quick_sort2(n_sort_arr, 0, len(n_sort_arr)-1)
    #print(n_sort_arr)
    #heapsort(n_sort_arr)
    #print(n_sort_arr)